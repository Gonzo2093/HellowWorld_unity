...
{
    // Ётот класс реализует шаблон проектировани€ "ќдиночка". —уществовать
    // только один экземпл€р Spawner> поэтому сохраним его в статической
    // переменной S.
    static public Spawner S;
    static public List<Boid> boids;

    // Ёти пол€ позвол€ют настраивать пор€док создани€ объектов Boid
